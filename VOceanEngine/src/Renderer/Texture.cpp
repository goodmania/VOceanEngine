...
//
//		VOE_CHECK_RESULT(vkAllocateCommandBuffers(device.GetVkDevice(), &cmdAllocateInfo, &cmdBuffer));
//		// also start recording for the new command buffer
//
//		VkCommandBufferBeginInfo cmdBufInfo = lve::initializers::commandBufferBeginInfo();
